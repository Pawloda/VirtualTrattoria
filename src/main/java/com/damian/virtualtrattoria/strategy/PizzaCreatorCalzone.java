...
/**
 * Class implements interface of pizza's creator. For calzone pizza.
 *
 * @author Damian
 * @version 1.0
 * @since 04.01.2022
 */
public class PizzaCreatorCalzone implements PizzaCreator {

    PizzaService pizzaService = new PizzaServiceImpl();

    @Override
    public PizzaTO createPizza(List<Ingredient> ingredients) {
        return pizzaService.createPizza(PizzaName.CALZONE, ingredients);
    }
