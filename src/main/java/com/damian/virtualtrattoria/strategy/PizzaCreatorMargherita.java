...
/**
 * Class implements interface of pizza's creator. For margherita pizza.
 *
 * @author Damian
 * @version 1.0
 * @since 04.01.2022
 */
public class PizzaCreatorMargherita implements PizzaCreator {

    PizzaService pizzaService = new PizzaServiceImpl();

    @Override
    public PizzaTO createPizza(List<Ingredient> ingredients) {
        return pizzaService.createPizza(PizzaName.MARGHERITA, ingredients);
    }
