...
/**
 * Class implements interface of pizza's creator. For funghi pizza.
 *
 * @author Damian
 * @version 1.0
 * @since 04.01.2022
 */
public class PizzaCreatorFunghi implements PizzaCreator {

    PizzaService pizzaService = new PizzaServiceImpl();

    @Override
    public PizzaTO createPizza(List<Ingredient> ingredients) {
        return pizzaService.createPizza(PizzaName.FUNGHI, ingredients);
    }
