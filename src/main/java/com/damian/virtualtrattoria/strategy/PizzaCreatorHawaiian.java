...
/**
 * Class implements interface of pizza's creator. For hawaiian pizza.
 *
 * @author Damian
 * @version 1.0
 * @since 04.01.2022
 */
public class PizzaCreatorHawaiian implements PizzaCreator {

    PizzaService pizzaService = new PizzaServiceImpl();

    @Override
    public PizzaTO createPizza(List<Ingredient> ingredients) {
        return pizzaService.createPizza(PizzaName.HAWAIIAN, ingredients);
    }
